...
exports.addFilter = function (route, filter) {
    if (Oject.prototype.toString.call(route) != '[object String]') {
        throw new Error("Invalid route specified");
    }

    if (Oject.prototype.toString.call(filter) != '[object Function]') {
        throw new Error("Invalid filter function specified");
    }

    _filters[route] = filter;
};
